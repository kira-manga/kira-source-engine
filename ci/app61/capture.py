...
require(os.environ.get("GITHUB_REF") == "refs/heads/validation/app61-native-capture-20260915-04", "Wrong branch")
...
result = {"status": "NOT_RUN", "nonshipping": True, "errors": [], "commands": [],
          ...
          "scope": [":app:lintVitalAnalyzeRelease", ":app:dependencies", "--configuration", "releaseRuntimeClasspath", ":buildEnvironment", ":app:buildEnvironment"], "started": time.time()}
...
try:
    ...
    result["coverage"] = "Only affected lint and named runtime/plugin graph bootstrap; no bundle, test, Apple, complete-lock, or strict-consumption claim"
